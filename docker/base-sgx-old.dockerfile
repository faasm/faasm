...
# link with protobuf as a shared library, as reported in protobuf#206. We also
# need to build abseil-cpp as it is a transitive dependency of protobuf.
# WARNING: the abseil and protobuf versions must be compatible.

# ARG ABSEIL_VERSION=20250127.1
# RUN git clone -b ${ABSEIL_VERSION} \
    ...
    #         -DCMAKE_INSTALL_PREFIX=/opt/third \
    #     && cmake --build /tmp/abseil/build -j \
    #     && cmake --install /tmp/abseil/build
#
# ARG PROTOBUF_VERSION=v6.31.1
# RUN git clone -b ${PROTOBUF_VERSION} \
    #         https://github.com/protocolbuffers/protobuf.git \
    #         /tmp/protobuf \
    #     && cmake -S /tmp/protobuf -B /tmp/protobuf/build \
    #         -Dprotobuf_ABSL_PROVIDER=package \
    #         -Dabsl_DIR=/opt/third/lib/cmake/absl \
    #         -Dprotobuf_BUILD_SHARED_LIBS=OFF \
    #         -Dprotobuf_BUILD_TESTS=OFF \
    #         -DCMAKE_POSITION_INDEPENDENT_CODE=ON \
    #         -DCMAKE_CXX_STANDARD=17 \
    #         -DCMAKE_INSTALL_PREFIX=/opt/third \
    #     && cmake --build /tmp/protobuf/build -j \
