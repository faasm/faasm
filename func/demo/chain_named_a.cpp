...
FAASM_MAIN_FUNC() {
    ...
    unsigned int idB1 = faasmChainFunctionInput("chain_named_b", inputB1.data(), 3);
    unsigned int idB2 = faasmChainFunctionInput("chain_named_b", inputB2.data(), 3);
    unsigned int idC1 = faasmChainFunctionInput("chain_named_c", inputC1.data(), 2);
