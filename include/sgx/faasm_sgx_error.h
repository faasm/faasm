...
typedef enum _error{
    ...
    FAASM_SGX_WAMR_MODULE_NOT_BOUNDED = FAASM_SGX_ERROR(0xF),
    ...
    FAASM_SGX_UNABLE_TO_CREATE_CRT = FAASM_SGX_ERROR(0x14),
    FAASM_SGX_OCALL_FAILED = FAASM_SGX_ERROR(0x15),
    FAASM_SGX_CRT_THREAD_FAILED = FAASM_SGX_ERROR(0x16),
    FAASM_SGX_CRT_SOCKET_FAILED = FAASM_SGX_ERROR(0x17)
}faasm_sgx_status_t;

#define FAASM_SGX_OCALL_ERROR(X) (faasm_sgx_status_t)((FAASM_SGX_OCALL_FAILED << 16) | (X))
#define FAASM_SGX_OCALL_GET_SGX_ERROR(X) (0x0000FFFF & (X))
