...
typedef enum _faasm_error
{
    ...
    FAASM_SGX_KEY_GENERATION_FAILED = FAASM_SGX_ERROR(0x1D),
    FAASM_SGX_CREATE_REPORT_FAILED = FAASM_SGX_ERROR(0x1E),
    FAASM_SGX_GET_QUOTE_SIZE_FAILED = FAASM_SGX_ERROR(0x1F),
    FAASM_SGX_GET_QUOTE_FAILED = FAASM_SGX_ERROR(0x20),
    FAASM_SGX_SHARED_KEY_COMPUTATION_FAILED = FAASM_SGX_ERROR(0x21),
    FAASM_SGX_DECRYPTION_FAILED = FAASM_SGX_ERROR(0x22),
    FAASM_SGX_READ_RAND_FAILED = FAASM_SGX_ERROR(0x23),
    FAASM_SGX_PROTOCOL_ATTESTATION_FAILED = FAASM_SGX_ERROR(0x24),
    FAASM_SGX_PROTOCOL_LOADED_FUNCTION_MISMATCH = FAASM_SGX_ERROR(0x25),
    FAASM_SGX_ENCRYPTION_FAILED = FAASM_SGX_ERROR(0x26),
    FAASM_SGX_NOT_IMPLEMENTED = FAASM_SGX_ERROR(0x27),
    FAASM_SGX_CHAIN_POLICY_HASH_MISMATCH = FAASM_SGX_ERROR(0x28),
    FAASM_SGX_CHAIN_POLICY_PAYLOADLEN_MISMATCH = FAASM_SGX_ERROR(0x29),
    FAASM_SGX_CHAIN_POLICY_FUNCID_MISMATCH = FAASM_SGX_ERROR(0x2A),
    FAASM_SGX_UNKNOWN_EXECUTION_TYPE = FAASM_SGX_ERROR(0x2B),
    FAASM_SGX_EMPTY_PAYLOAD = FAASM_SGX_ERROR(0x2C),
    FAASM_SGX_KM_SEND_FAILED = FAASM_SGX_ERROR(0x2D),
    FAASM_SGX_KM_RECV_FAILED = FAASM_SGX_ERROR(0x2E),
    FAASM_SGX_KM_STATUS_ERROR = FAASM_SGX_ERROR(0x2F),
    FAASM_SGX_NONCE_ALREADY_SEEN = FAASM_SGX_ERROR(0x30),
    FAASM_SGX_UNKNOWN_MSG_ID = FAASM_SGX_ERROR(0x31),
    FAASM_SGX_MISSING_RESULT = FAASM_SGX_ERROR(0x32),
    FAASM_SGX_RETURN_VALUE_MISMATCH = FAASM_SGX_ERROR(0x33),
    FAASM_SGX_CORRUPTED_CHAIN_POLICY = FAASM_SGX_ERROR(0x34),
    FAASM_SGX_RESULT_OUTPUT_MISLINK = FAASM_SGX_ERROR(0x35),
    FAASM_SGX_INVALID_INPUT_NONCE = FAASM_SGX_ERROR(0x36),
    FAASM_SGX_PROTOCOL_FAASLET_ATTESTATION_FAILED = FAASM_SGX_ERROR(0x37),
    FAASM_SGX_HASH_FAILED = FAASM_SGX_ERROR(0x38),
    FAASM_SGX_NONCE_MISMATCH = FAASM_SGX_ERROR(0x39),
    FAASM_SGX_ECALL_FAILED = FAASM_SGX_ERROR(0x40),
    FAASM_SGX_SDK_CALL_FAILED = FAASM_SGX_ERROR(0x41),
} faasm_sgx_status_t;
