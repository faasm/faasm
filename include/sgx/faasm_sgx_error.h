...
typedef enum _error{
    ...
    FAASM_SGX_WAMR_UNABLE_TO_FIND_TCS_SLOT = FAASM_SGX_ERROR(0xE),
    FAASM_SGX_INVALID_THREAD_ID = FAASM_SGX_ERROR(0xF),
    FAASM_SGX_WAMR_MODULE_NOT_BOUNDED = FAASM_SGX_ERROR(0x10),
    FAASM_SGX_UNABLE_TO_ENTER_ENCLAVE = FAASM_SGX_ERROR(0x11)
}faasm_sgx_status_t;
