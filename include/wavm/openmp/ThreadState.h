...
extern thread_local int
  wantedNumThreads; // Desired number of thread set by omp_set_num_threads for
                    // all future levels
extern thread_local int
  pushedNumThreads; // Num threads pushed by compiler, valid for one parallel
                    // section, overrides wanted
