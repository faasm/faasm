...
static unsigned int faasm_chain_function_input_wrapper(wasm_exec_env_t exec_env, const char *name, const uint8_t *input,
...
static unsigned int faasm_chain_this_input_wrapper(wasm_exec_env_t exec_env, int idx,
