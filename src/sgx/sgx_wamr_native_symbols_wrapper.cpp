...
static unsigned int
faasm_chain_function_input(wasm_exec_env_t exec_env, const char *name, const uint8_t *input, long input_size) {
    //Todo: sgx_ret_val
...
static unsigned int
faasm_chain_this_input_wrapper(wasm_exec_env_t exec_env, int idx, const uint8_t *input_data, long input_size) {
    unsigned int ret_val;
