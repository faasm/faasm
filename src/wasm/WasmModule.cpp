...
namespace wasm {
    ...
    Runtime::Function *WasmModule::getFunction(Runtime::Instance *module, const std::string &funcName, bool strict) {
        const std::shared_ptr<spdlog::logger> &logger = util::getLogger();
    ...
    Runtime::Function *WasmModule::getMainFunction(Runtime::Instance *module) {
    ...
    Runtime::Function *WasmModule::getWasmConstructorsFunction(Runtime::Instance *module) {
        return getFunction(module, WASM_CTORS_FUNC_NAME, false);
    }

    Runtime::Function *WasmModule::getDefaultZygoteFunction(Runtime::Instance *module) {
        return getFunction(module, ZYGOTE_FUNC_NAME, false);
    }
    
    void WasmModule::executeZygoteFunction() {
        const std::shared_ptr<spdlog::logger> &logger = util::getLogger();
    ...
    void WasmModule::executeWasmConstructorsFunction(Runtime::Instance *module) {
        const std::shared_ptr<spdlog::logger> &logger = util::getLogger();
