...
namespace wasm {
    ...
    WAVM_DEFINE_INTRINSIC_FUNCTION(env, "__faasm_chain_function", U32, __faasm_chain_function,
        ...
        faabric::util::getLogger()->debug("S - chain_function - {} {} {}", funcName, inputDataPtr, inputDataLen);
    ...
    WAVM_DEFINE_INTRINSIC_FUNCTION(env, "__faasm_chain_this", U32, __faasm_chain_this,
        ...
        faabric::util::getLogger()->debug("S - chain_this - {} {} {}", idx, inputDataPtr, inputDataLen);
    ...
    WAVM_DEFINE_INTRINSIC_FUNCTION(env, "__faasm_chain_py", U32, __faasm_chain_py,
        ...
        faabric::util::getLogger()->debug("S - chain_py - {} {} {}", pyFuncName, inputDataPtr, inputDataLen);
