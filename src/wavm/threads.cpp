...
namespace wasm {
    ...
    WAVM_DEFINE_INTRINSIC_FUNCTION(env, "pthread_exit", void, pthread_exit, I32 code) {
        faabric::utilgetLogger()->debug("S - pthread_exit - {}", code);
